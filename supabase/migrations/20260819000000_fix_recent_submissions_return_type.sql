-- Fix get_recent_test_submissions to return proper JSON type that matches TypeScript
-- This avoids "structure of query does not match function result type" error
...
-- Secure the function: revoke anon access, grant only to authenticated
