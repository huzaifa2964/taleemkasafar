...
/**
 * Dashboard hero section with personalized welcome message.
 * 
 * Dynamically adjusts content based on user activity:
 * - First-time users: personalized welcome with their name
 * - Returning users: motivational message to beat their last score
 * 
 * Provides quick access to primary features (mock tests and topic practice).
 */
